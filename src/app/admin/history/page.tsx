            ...
            return (
              <div key={h.id} className="card p-4">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <span className="text-xs font-black font-mono" style={{color:'#60a5fa'}}>{h.booking_number}</span>
                ...
                <div className="space-y-1 text-xs" style={{color:'#64748b'}}>
                  ...
                  <div className="flex justify-between pt-2 mt-1" style={{borderTop:'1px solid rgba(255,255,255,0.05)'}}>
                    <span style={{color:h.prepayment_status==='returned'?'#60a5fa':'#4b5563'}}>{h.prepayment_status==='returned'?'↩️ Возвр.':h.prepayment_status==='confirmed'?'✅ Оплач.':'—'}</span>
