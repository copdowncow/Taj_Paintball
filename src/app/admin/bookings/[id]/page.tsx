...
export default function BookingDetailPage() {
  ...
  if(loading) return <div className="p-12 text-center" style={{color:'#3b82f6'}}>Загрузка...</div>;
  ...
  return (
    <div className="p-5 max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-xl font-black text-white">Бронь <span style={{color:'#60a5fa'}}>{booking.booking_number}</span></h1>
          ...
          <div className="card p-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                {l:'✅ Подтвердить',fn:()=>doAction(`/api/admin/bookings/${id}/status`,{status:'confirmed'}),color:'#3b82f6'},
            ...
            {booking.logs.map(log=>(
              <div key={log.id} className="p-4 text-sm" style={{borderBottom:'1px solid rgba(255,255,255,0.04)'}}>
                <div className="flex justify-between items-start mb-1">
                  <span className="font-semibold" style={{color:'#60a5fa'}}>{log.event_type}</span>
